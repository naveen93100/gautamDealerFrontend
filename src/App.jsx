...
//             {/* Company selection is the entry point, outside the guard */}
//             <Route path="/select-company" element={<SelectCompany />} />

//             {/* Everything below requires a company to already be picked */}
//             <Route element={<CompanyRoute />}>
//                 <Route element={<PublicRoute />}>
//                     {/* <Route path="/login" element={<Login />} /> */}
//                     <Route path="/login" element={<CompanyAwareLogin />} />
//                     <Route path="/register" element={<Registration />} />
//                     <Route
//                         path="/create-password/:token"
//                         element={<CreatePassword />}
...
//                 {/*start galo */}
//                 <Route path="/galo/dashboard" element={<GaloDashboard />} />

//                 <Route path="galo-panel-history" element ={<GlaoSalesClientPanelHistory/>} />
