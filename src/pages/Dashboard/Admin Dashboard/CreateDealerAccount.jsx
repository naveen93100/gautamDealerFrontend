...
const CreateDealerAccount = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            let res = await apiCall('POST', '/adminPanel/create-dealer-account', formData);
    ...
    return (
        <>
            ...
            <div className=" min-h-screen bg-[#ffffff] rounded-2xl p-6">
                <h1 className="text-lg font-bold text-gray-900 mb-1">Create Dealer Account</h1>
                <p className="text-xs text-gray-400 mb-5">Fill in the details to register a new dealer.</p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-4 border-t border-gray-300">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group h-[120px] flex flex-col items-center justify-center border-2 border-dashed border-gray-400 rounded-xl hover:border-[#a20000] hover:bg-red-50/30 transition-all cursor-pointer overflow-hidden bg-gray-50">
                                <img src={imgPrev} alt="" className="w-20 rounded-md" />
                    ...
                    <div className="pt-6">
                        ...
                        >
                            {loading ? <LoaderCircle className="animate-spin" /> :
                                <span className="relative z-10 uppercase">Create Account</span>
                            }
