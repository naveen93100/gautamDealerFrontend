...
const Registration = () => {
    ...
    return (
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6 font-sans">
            <div className="bg-white p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] w-full max-w-5xl border border-gray-100">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
                        ...
                        {[
                            { id: "firstName", label: "First Name", icon: <FiUser />, placeholder: "John" },
                            { id: "lastName", label: "Last Name", icon: <FiUser />, placeholder: "Doe" },
                            { id: "email", label: "Email Address", icon: <FiMail />, placeholder: "john@example.com", type: "email" },
                            { id: "gstin", label: "GSTIN", icon: <FiFileText />, placeholder: "22AAAAA0000A1Z5" },
                            { id: "companyName", label: "Company Name", icon: <FiHome />, placeholder: "Global Traders Inc." },
                            { id: "contact", label: "Contact Number", icon: <FiPhone />, placeholder: "9876543210", maxLength: 10 },
                        ].map((field) => (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pt-4 border-t border-gray-100">
                        ...
                        <div className="lg:col-span-2 space-y-2">
                            ...
                            <textarea
                                className="w-full bg-gray-50 text-gray-800 resize-none placeholder-gray-400 p-4 rounded-xl border border-gray-200 focus:outline-none focus:border-[#a20000] focus:bg-white focus:ring-4 focus:ring-red-50 transition-all min-h-[120px]"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group h-[120px] flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-xl hover:border-[#a20000] hover:bg-red-50/30 transition-all cursor-pointer overflow-hidden bg-gray-50">
