...
//         useClasses: true,
//     }
//     const isEdit = data?.proposalsData?.length > 0;
...
//     const selectedMaterial = watch('components') || [];
...
//                     address: d.address,
//                     rate: d.rate,
//                     orderCapacity: d.orderCapacity,
//                     tax: d.tax,
//                     components: d.components,
//                     termsAndConditions: Body,
//                     propId: data.proposalsData[0]._id
//                 };

//                 const res = await apiCall('PATCH', '/api/dealer/edit-proposal', formData);
...
//                 const res = await apiCall('POST', '/api/dealer/create-propsal', d);
...
//         let updated = [...selectedMaterial];
//         const index = updated.findIndex(v => v.name === item);
...
//     useEffect(() => {
//         setValue("components", MATERIALS.map(i => ({ name: i, qty: 1 })));
//     }, []);
...
//         const p = data.proposalsData[0];

//         setValue('customerName', data.name);
//         setValue('email', data.email);
//         setValue('phone', data.phone);
//         setValue('address', data.address);
//         setValue('orderCapacity', p.orderCapacity / 1000);
//         setValue('rate', p.rate);
//         setValue('tax', p.tax);

//         setBody(p.termsAndConditions);
...
//                                     const match = selectedMaterial?.find(v => v.name === item);
...
//                                                     onChange={(e) =>
//                                                         handleSelect(Number(e.target.value || 0), item)
//                                                     }
//                                                     type="number"
