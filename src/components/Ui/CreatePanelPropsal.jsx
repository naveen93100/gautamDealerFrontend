...
import { Mail, MessageCircle, Phone, Sun, User, X, Zap } from 'lucide-react'
import React, { useState } from 'react'
import { useForm } from 'react-hook-form'
import { BiRupee } from 'react-icons/bi'

const CreatePanelPropsal = ({ setClose }) => {
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full min-h-[90vh] overflow-hidden">
        ...
        <div className="bg-[#d40202] p-4 text-white relative">
          <button
            ...
            className="absolute cursor-pointer top-4 right-4 p-2 hover:bg-white/20 rounded-full transition-all"
          >
            <X className="w-5 h-5" />
          </button>

          <div className="flex items-center gap-4">
            <div className=" bg-white/20 backdrop-blur-sm p-1 rounded-2xl flex items-center justify-center">
              <Sun className="size-8 text-white" />
            </div>
            <div>
              <h2 className="text-xl font-bold">New Solar Panels</h2>
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-50px)]">
            ...
            <section className="mb-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-semibold">Solar Panels Capacity (kW)</h3>
              </div>
            ...
            <div className="items-center justify-center bg-gray-50 flex gap-3 mt-5">
              ...
              <button
                type="submit"
                className={` p-3 sm:flex-1 bg-linear-to-r from-red-600 to-red-600 text-white rounded-xl cursor-pointer}`}
              >
...
export default CreatePanelPropsal